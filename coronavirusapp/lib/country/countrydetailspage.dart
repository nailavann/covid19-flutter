...
class CountryDetailsPage extends StatefulWidget {
  ...
  const CountryDetailsPage(
      ...
      required this.sortedCountryDatas,
      this.sorted})
      : super(key: key);
...
class _CountryDetailsPageState extends State<CountryDetailsPage> {
  ...
  _CountryDetailsPageState(
      this.countryData, this.sortedCountryDatas, this.sorted);
                  ...
                  children: [
                    ...
                    DetailsPanel(
                      ...
                      count: sorted == false
                          ...
                          : sortedCountryDatas['todayCases'].toString(),
                    ...
                    DetailsPanel(
                        ...
                        count: sorted == false
                            ...
                            : sortedCountryDatas['todayDeaths'].toString(),
                        panelColor: panelColor,
                    ...
                    DetailsPanel(
                      ...
                      count: sorted == false
                          ...
                          : sortedCountryDatas['todayRecovered'].toString(),
                      panelColor: panelColor,
                        textColor: Theme.of(context).textSelectionTheme.selectionColor,
                    ),
                    DetailsPanel(
                      ...
                      count: sorted == false
                          ...
                          : sortedCountryDatas['cases'].toString(),
                      panelColor: panelColor,
                      textColor: Theme.of(context).textSelectionTheme.selectionColor,
                    ),
                    DetailsPanel(
                      ...
                      count: sorted == false
                          ...
                          : sortedCountryDatas['deaths'].toString(),
                      panelColor: panelColor,
                      textColor: Theme.of(context).textSelectionTheme.selectionColor,
                    ),
                    DetailsPanel(
                      ...
                      count: sorted == false
                          ...
                          : sortedCountryDatas['recovered'].toString(),
                      panelColor: panelColor,
                      textColor: Theme.of(context).textSelectionTheme.selectionColor,
                    ),
                  ],
